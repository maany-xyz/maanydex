...
import (
	...
	interchaintransactionsmodulekeeper "github.com/neutron-org/neutron/v5/x/interchaintxs/keeper"
...
func RegisterCustomPlugins(
	...
	wasmQueryPlugin := NewQueryPlugin(ictxKeeper, icqKeeper, feeBurnerKeeper, feeRefunderKeeper, tfk, contractmanagerKeeper, oracleKeeper, markemapKeeper)

	queryPluginOpt := wasmkeeper.WithQueryPlugins(&wasmkeeper.QueryPlugins{
		Custom: CustomQuerier(wasmQueryPlugin),
	})
	messagePluginOpt := wasmkeeper.WithMessageHandlerDecorator(
		CustomMessageDecorator(ictxKeeper, icqKeeper, adminKeeper, bank, tfk, cronKeeper, contractmanagerKeeper),
	)
